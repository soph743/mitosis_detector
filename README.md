...
## Description
A model to classify cells from the MIDOG++ dataset as 'mitotic' or 'not mitotic' using multiple approaches. The dataset contains 7 cell types and 25,000+ images.
